...
const DashboardCardDesign = ({ title, value, subTitle, customStyle }) => {
  return (
    <div>
      <div className="adminCard work ">
        ...
        <div className={`adminCard-desc shadow-xl ${customStyle?.mainBg}`}>
          <div className="adminCard-header">
            <div className="adminCard-title">{title}</div>
            <div className="adminCard-menu">
          ...
          <div className="adminCard-time">
            {!value.includes("undefined") ? (
              ...
              <button className="btn bg-opacity-0 border-none loading"></button>
            )}
          </div>
          <p className="recent">{subTitle}</p>
        </div>
      </div>
    </div>
  );
...
export default DashboardCardDesign;
